...
class TestAPI:
    ...
    def test_review_creation(self):
        product = Product.objects.create(title="Test Product", asin="123456")
        review = Review.objects.create(product=product, title="Test Review", review="This is a test review")
    ...
    def test_review_create(self, api_client):
        ...
        data = {'product': product.pk, 'title': 'Test Review', 'review': 'This is a test review'}
    ...
    def test_invalid_review_create_invalid_product(self, api_client):
        url = reverse('review-create')
        data = {'product': 999, 'title': 'Invalid Review', 'content': 'This review should not be created'}
        response = api_client.post(url, data, format='json')
